 ...
 */
final class Version20260908074410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE absences (id INT AUTO_INCREMENT NOT NULL, date_time DATE NOT NULL, reason_id INT NOT NULL, trainee_id INT DEFAULT NULL, INDEX IDX_F9C0EFFF59BB1592 (reason_id), INDEX IDX_F9C0EFFF36C682D0 (trainee_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE trainee (id INT AUTO_INCREMENT NOT NULL, lastname VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, training_id INT NOT NULL, INDEX IDX_46C68DE7BEFD98D1 (training_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
